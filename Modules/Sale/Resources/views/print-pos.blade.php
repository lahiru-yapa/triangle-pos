            ...
            <table class="table-data">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;vertical-align:bottom">{{ format_currency($saleDetail->sub_total) }}
                        </td>
                    </tr>
                    @endforeach
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <th style="text-align:right">{{ format_currency(($sale->paid_amount)-($sale->total_amount)) }}
                        </th>
                    </tr>
                    </tr>
                    ...
                    <tr style="border-bottom: 0;">
                        <td class="centered" colspan="3">
                            <div style="margin-top: 10px;">
                                {!! \Milon\Barcode\Facades\DNS1DFacade::getBarcodeSVG($sale->reference, 'C128', 1, 25,
                                'black', false) !!}
                            </div>
                        </td>
                    </tr>
